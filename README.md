...
Good `topC` values usually fall between 5 and 20. We recommended using values 5, 10, and 20.

The `decay` parameter must fall between 0 and 1. We recommended using values 0.7 and 0.9.
